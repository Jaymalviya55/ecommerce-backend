...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260730110001_UpdateUserManagementSchema")]
    partial class UpdateUserManagementSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.SupportTicket", b =>
                {
                    ...
                    b.Property<bool>("IsHumanRequested")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.TicketMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.UserManagement.UserLevel", b =>
                {
                    b.Property<int>("UserLevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserLevelId"));
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.UserManagement.UserLogin", b =>
                {
                    ...
                    b.Property<bool>("IsDefaultPasswordChange")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.UserManagement.UserRole", b =>
                {
                    ...
                    b.Property<bool>("ApplicableToAllSelectedLevelUser")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.TicketMessage", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.SupportTicket", "Ticket")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.UserManagement.UserLevel", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.UserManagement.UserType", "UserType")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.UserManagement.UserLogin", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.UserManagement.UserLevel", "UserLevel")
                        .WithMany()
